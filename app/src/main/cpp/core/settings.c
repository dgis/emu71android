...
#if !defined EMU71_INI
	#define EMU71_INI "Emu71.ini"
#endif

#define ReadString(sec,key,dv,v,sv) GetPrivateProfileString(sec,key,dv,v,sv,_T(EMU71_INI))
#define ReadInt(sec,key,dv)         GetPrivateProfileInt(sec,key,dv,_T(EMU71_INI));
#define WriteString(sec,key,v)      WritePrivateProfileString(sec,key,v,_T(EMU71_INI))
#define WriteInt(sec,key,v)         WritePrivateProfileInt(sec,key,v,_T(EMU71_INI))
#define DelKey(sec,key)             WritePrivateProfileString(sec,key,NULL,_T(EMU71_INI))
...
// registry handling
	...
	#define REGISTRYKEY "Software\\Emu71"
#endif
...
{
	// Files
	ReadString(_T("Files"),_T("Emu71Directory"),szCurrentDirectory,szEmuDirectory,ARRAYSIZEOF(szEmuDirectory));
...
{
	// Files
	WriteString(_T("Files"),_T("Emu71Directory"),szEmuDirectory);
